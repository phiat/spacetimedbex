if Code.ensure_loaded?(Phoenix.PubSub) do
  defmodule Spacetimedbex.Phoenix do
    @moduledoc """
    Phoenix PubSub adapter for SpacetimeDB. Requires the optional
    `:phoenix_pubsub` dependency.
    ...
    A row update (same primary key) is broadcast as a `:delete` of the old row
